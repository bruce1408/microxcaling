...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/microxcaling/context` | Codebase overview, check index freshness |
| `gitnexus://repo/microxcaling/clusters` | All functional areas |
| `gitnexus://repo/microxcaling/processes` | All execution flows |
| `gitnexus://repo/microxcaling/process/{name}` | Step-by-step execution trace |
